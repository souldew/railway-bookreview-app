...
export const Detail = () => {
  ...
  const [bookreview, setBookreview] = useState<Bookreview | undefined>(undefined);
      ...
      <main>
        {bookreview ? (
          <>
            ...
            <div className="font-black text-lg">レビュアー</div>
            <div className="mt-1 ml-4 mb-4 w-4/5">{bookreview.reviewer}</div>
